...
JVM_OPTS="$JVM_OPTS -Xloggc:${CASSANDRA_HOME}/logs/gc.log -Djdk.nio.maxCachedBufferSize=262144"
...
if [ "$LOCAL_JMX" = "yes" ]; then
  ...
  JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=$(curl -s 169.254.169.254/latest/meta-data/local-ipv4)"
fi
